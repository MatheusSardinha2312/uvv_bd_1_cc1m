create user matheus superuser createdb createrole inherit login password '12345';
...
create schema if not exists elmasri authorization matheus;
...
COMMENT ON TABLE elmasri.funcionario IS 'Tabela com informações gerais de cada funcionario';
COMMENT ON COLUMN elmasri.funcionario.cpf IS 'Coluna com o cpf do funcionário';
COMMENT ON COLUMN elmasri.funcionario.primeiro_nome IS 'Coluna com o primeiro nome do funcionário';
COMMENT ON COLUMN elmasri.funcionario.nome_meio IS 'Coluna com o nome do meio do funcionário';
...
COMMENT ON COLUMN elmasri.funcionario.sexo IS 'Coluna com o sexo do funcionário';
...
COMMENT ON TABLE elmasri.dependente IS 'Tabela com os dados do dependente';
COMMENT ON COLUMN elmasri.dependente.cpf_funcionario IS 'Coluna com o cpf do funcionário ';
COMMENT ON COLUMN elmasri.dependente.nome_dependente IS 'Coluna com o nome do dependente';
COMMENT ON COLUMN elmasri.dependente.sexo IS 'Coluna com o sexo do dependente';
COMMENT ON COLUMN elmasri.dependente.data_nascimento IS 'Coluna com a data de nascimento do dependente';
COMMENT ON COLUMN elmasri.dependente.parentesco IS 'Coluna com o parentesco do dependente';
...
COMMENT ON TABLE elmasri.departamento IS 'Tabela com os dados do departamento ';
COMMENT ON COLUMN elmasri.departamento.numero_departamento IS 'Coluna com o número do departamento ';
COMMENT ON COLUMN elmasri.departamento.nome_departamento IS 'Coluna com o nome do departamento ';
COMMENT ON COLUMN elmasri.departamento.cpf_gerente IS 'Coluna com o cpf do gerente';
COMMENT ON COLUMN elmasri.departamento.data_inicio_gerente IS 'Coluna com a data de ínicio do gerente';
...
COMMENT ON TABLE elmasri.projeto IS 'Tabela com os dados do projeto ';
COMMENT ON COLUMN elmasri.projeto.numero_projeto IS 'Coluna com o número do projeto  ';
COMMENT ON COLUMN elmasri.projeto.nome_projeto IS 'Coluna com o nome do projeto ';
COMMENT ON COLUMN elmasri.projeto.local_projeto IS 'Coluna com o local do projeto';
COMMENT ON COLUMN elmasri.projeto.numero_departamento IS 'Coluna com o número do departamento';
...
COMMENT ON TABLE elmasri.trabalha_em IS 'Tabela com os dados de trabalha em';
COMMENT ON COLUMN elmasri.trabalha_em.cpf_funcionario IS 'Coluna com o cpf do funcionário ';
COMMENT ON COLUMN elmasri.trabalha_em.numero_projeto IS 'Coluna com o número do projeto';
COMMENT ON COLUMN elmasri.trabalha_em.horas IS 'Coluna com o número de horas';
...
COMMENT ON TABLE elmasri.localizacoes_departamento IS 'Tabela com as localizações do departamento ';
COMMENT ON COLUMN elmasri.localizacoes_departamento.numero_departamento IS 'Coluna com o número do departamento';
COMMENT ON COLUMN elmasri.localizacoes_departamento.local IS 'Coluna com o local do departamento  ';
